...
\usepackage{tabularx}
\frenchspacing
\usepackage[normalem]{ulem}  % provides strikethrough /sout command for editing

% \usepackage{parskip}
% \usepackage[skip=0.5pt, indent=0pt]{parskip}
...
\newcommand{\shadiS}[1]{ {\note{\bf \color{blue} #1}} }
\newcommand{\dhl}[1]{ {\note{\color{orange} DHL: #1}} }
\newcommand{\amit}[1]{ {\note{\color{purple} Amit: #1}} }
\newcommand{\seb}[1]{ {\note{\color{darkgreen} Seb: #1}} }
% \newcommand{\majoredits}[1]{ {\color{blue}#1} }
% \newcommand{\minoredits}[1]{ {\color{blue}#1} }
% \newcommand{\secondedits}[1]{ {\color{green}#1} }
% \newcommand{\remove}[1]{ {\note{\sout{#1}}} }
