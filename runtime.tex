...
\shadiS{
In this section, we describe how \name{}  efficiently implements
orchestration and the six transition patterns in a decentralized manner.  \name{} adds a  \name{} runtime to each  user function to perform the transitions. The \name{} runtime consists
of an ingress and an egress component.
}
...
\shadiS{To achieve this, \name{} relies on a strongly consistent data store with conditional writes}. \name{} egress always writes the output of the fan-in source
...
single object \shadiS{(which requires the conditional write ability from the data store)}. Specific implementation depends on the data store and we
