...
\hline
\textbf{} &
  \multicolumn{3}{c|}{\textbf{Latency (seconds)}} &
  \multicolumn{3}{c|}{\textbf{Costs (\$ per 1 mil. executions)}} \\ \hline
\textbf{Application} &
  \multicolumn{1}{c|}{\textit{Unum (no GC)}} &
  \multicolumn{1}{c|}{\textit{Unum (GC)}} &
...
\textit{IoT Pipeline} &
  ...
  \multicolumn{1}{r|}{0.12} &
  0.23 &
  \multicolumn{1}{r|}{\$6.19} &
  \multicolumn{1}{r|}{\$11.83} &
  \$112.10 \\ \hline
\textit{Text Processing} &
  \multicolumn{1}{r|}{0.46} &
  \multicolumn{1}{r|}{0.52} &
  0.55 &
  \multicolumn{1}{r|}{\$27.29} &
  \multicolumn{1}{r|}{\$52.62} &
  \$196.30 \\ \hline
\textit{Wordcount} &
  \multicolumn{1}{r|}{405.70} &
  \multicolumn{1}{r|}{408.88} &
  898.56 &
  \multicolumn{1}{r|}{\$6,770.02} &
  \multicolumn{1}{r|}{\$15,904.57} &
  \$18,113.00 \\ \hline
\textit{ExCamera} &
  \multicolumn{1}{r|}{84.46} &
  \multicolumn{1}{r|}{84.52} &
  98.42 &
  \multicolumn{1}{r|}{\$49,306.90} &
  \multicolumn{1}{r|}{\$77,298.35} &
  \$110,494.70 \\ \hline
  \end{tabular}
