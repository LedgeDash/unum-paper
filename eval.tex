...
questions: \shadi{if short on space, can compress the following Q's }
...
In this section, we analyze \name{} on a series of micro-benchmark patterns in terms of both cost and latency. \shadi{do we have cost for micro bench?}
...
system, and not the latency of user code. Therefore, we use a constituent \shadi{can we use better term?}
...
taken from serverless application repositories and prior research work, covering a wide range of use cases and workflow patterns: \shadi{if we have space, it would be good to have a small figure with the graph of each app. that helps to show the patterns and complexity of excamera}
...
\begin{itemize}
	...
	previous chunk.\shadiS{chunk\textbf{s}?}
	...
	thunk abstraction. \shadi{what is thunk? is it important? maybe remove}We use the exact same workload and setup as the
