...
without any changes to your application. \dhl{needs rephrasing}
...
first 888 chunks of the \texttt{sintel-4k}~\cite{sintel} video using 16 chunks
per batch and Lambdas configured with 3GB of memory), \name{} is 7.1\% faster
than gg~\cite{gg-atc} and 10.5\% slower than the original ExCamera
