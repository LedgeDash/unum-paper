...
\begin{table*}[t]
  ...
  \begin{tabular}{ll|rrr|rr}
    \hline
    &                        & \multicolumn{3}{c}{\textbf{Latency (seconds)}}            & \multicolumn{2}{c}{\textbf{Cost (\$ per \emph{1 mil.} executions)}}       \\
    \textbf{Application} & \textbf{Pattern}       & \textit{\name{} (aws)} & \textit{\name{} (gcloud)} & \textit{Step Functions}   & \textit{\name{}} & \textit{Step Functions}            \\ \hline
    IoT Pipeline         & chain                  & 0.18      & 0.81 & 0.23       & 4.1       & 112.1   \\
    Text Processing      & fan-out, fan-in        & 0.56      & 3.56 & 0.55       & 12.0      & 196.3   \\
    Wordcount            & chain, fan-out, fan-in & 410.64    & 484.00 & 898.56     & 4,904.8   & 18,113.0 \\
    ExCamera             & chain, fan-out, fold   & 84.17     & 393.46 & 98.42      & 37,289.1   & 110,494.7      \\ \hline
  \end{tabular}
