...
\begin{table}[]
  ...
  \end{tabular}
  \caption{\name{}'s implementation closely matches the original
    ExCamera. Conversely, the Step Functions implementation must serialize the encoding and re-encoding
    stages resulting in less parallelism.}
