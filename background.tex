...
(e.g., branching, chaining, fan-out and fan-in)~\cite{excamera, gg-atc, aws-step-functions, google-cloud-composer, google-workflows,
...
orchestrators~\cite{temporal, gg-atc, excamera} and deploy them in VMs alongside
their functions.}
