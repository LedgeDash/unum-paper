...
more than one execution of the function.

This presents a challenge for large applications whose constituent functions
are non-deterministic because a single invocation can produce multiple
\emph{diverging} results.}
...
\dhledit{One of the benefits of orchestrators is strong execution semantics
