...
\begin{figure*}[t]
	...
	\centering
		...
		function, \name{} config and \name{}'s runtime library \shadiS{(a pair of ingress and egress nodes)} together to
		create unumized functions. \shadi{mark ''unum runtime'' in the figure.}}
...
function invokes the sink function. \shadi{ maybe remove the last sentence?... seems out of place and too detailed for here}
...
exactly-once execution semantics. \shadi{Does this match the new structure? update accordingly.}
