...
\dhledit{However, standalone orchestrators have cons for both cloud providers
and cloud users/application developers. Standalone orchestrators require cloud
providers to (build,) host and scale yet another performance-critical
service. Standalone orchestrators also preclude users from making
their own trade-offs between available interactions or execution guarantees
and performance, resource overhead, \remove{scalability}(\dhl{need example for this}) and
