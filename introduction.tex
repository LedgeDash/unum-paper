...
% building distributed applications. Developers build applications in the form
% of event-driven functions without the need to provision and manage resources.
% Serverless platforms execute functions with fast autoscaling that can start
% thousands of functions in a matter of seconds, fine-grained billing that only
% charges users for resources used and not for resources allocated but idle, and
% improved resource multiplexing that can scale functions down to zero after
...
% Removes the effort to build and maintain specialized hosted
% workflow services
