...
\majoredits{In this paper, we show that additional standalone orchestrators
 ...
 for cloud providers as it reduces hardware and engineering costs by
 obviating the need to host an additional complex service, which can in turn
 lower users' costs of running applications}. Moreover, as cloud providers
 improve the performance of essential serverless components,
...
cost significantly less with \name{} than Step Functions. We also demonstrate
that \name{}'s IR allows hand-tuned applications to run faster by using
application-specific optimizations and supporting a richer set of interaction
patterns.
