...
\majoredits{Cloud providers and application developers have introduced standalone
...
\majoredits{Although they are likely internally distributed, standalone
...
\majoredits{In this paper, we argue that additional standalone services
